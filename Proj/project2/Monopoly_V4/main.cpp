                    ...
                    if(game!=false){
                        ...
                        for(int i=1;i<=turn;i++){
                            ...
                            if(p.p1loc==4 || p.p1loc==38){
                                pay(p.p1bal,p.p1loc,c.c1bal,c.c1loc,who);
                            }
                            if(p.p1loc==7 || p.p1loc==22 || p.p1loc==36){
                                chance(p.p1loc,pmove,p.p1,p.p1bal,c.c1loc,cmove,c.c1,c.c1bal,prison,cprison,who);
                            }
                            if(p.p1loc==2 || p.p1loc==17 || p.p1loc==33){
                                chest(p.p1loc,pmove,p.p1,p.p1bal,c.c1loc,cmove,c.c1,c.c1bal,prison,cprison,who);
                            }
                            if(p.p1loc==30){
                                prison=false;
                                jail(p.p1loc,pmove,p.p1,c.c1loc,cmove,c.c1,who);
                            }
