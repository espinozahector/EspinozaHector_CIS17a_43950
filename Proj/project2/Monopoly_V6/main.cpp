                    ...
                    if(game!=false){
                        if(prison==false){
                            ...
                            for(int i=1;i<=turn;i++){
                                ...
                                win(h,c1bal,game);//determines the winner
